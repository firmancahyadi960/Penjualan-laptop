...
import pembelian.PembelianDAOImp;
 ...
 * @author USER
 */
public class PembelianItemForm extends javax.swing.JFrame {
    
    private PembelianItemDAO dao = new PembelianItemDAOImp();
    pembelian.PembelianDAO daopen = new PembelianDAOImp();
    ...
    public void loadSupplier() {
        ...
        cbSupplier.addItem("-- Pilih --");
        supplierId.add(0);
        for (Supplier b : dao.loadSupplier()) {
            cbSupplier.addItem(b.getNama());
            supplierId.add(b.getId());
        }
    }
    ...
    public void getSubtotal() {
        ...
        if (!tfqty.getText().isEmpty()) {
            pembelianItem.setQty(Integer.valueOf(tfqty.getText()));
            pembelianItem.setSubTotal(pembelianItem.getQty() * barang.getHargabeli());
            tfsubtotal.setText(String.valueOf(pembelianItem.getSubTotal()));
        }
    }
   
    
    public void addItem() {
        pembelianItem.setBarang(barang);
        dao.addItem(pembelianItem);
           ...
           // DecimalFormat df = new DecimalFormat("#,###,##0.00");
            if (cbBarang.getSelectedIndex() == 0 && tfqty.getText().isEmpty() && tfsubtotal.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "inputan belum lengkap");
                    ...
                    pembelianItem.setBarang(barang);
                    dao.editItem(index, pembelianItem);
...
//JOptionPane.showMessageDialog(null, e);
    ...
    public void save() {
        ...
        pembelian.setTotal(dao.refreshTotal());
        pembelian.setBayar(Double.valueOf(tfbayar.getText()));
        pembelian.setKembalian(Double.valueOf(tfbayar.getText()));
        ...
        supplier.setId(supplierId.get(cbSupplier.getSelectedIndex()));
        ...
        //simpan pembelian
        dao.insertPembelian(pembelian);
        daopen.cetak(String.valueOf(pembelian.getId()));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PEMBELIAN ITEM");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tfbayar, javax.swing.GroupLayout.DEFAULT_SIZE, 424, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PembelianItemForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
